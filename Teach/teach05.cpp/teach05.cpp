...
*
* Instructions:
* As a team, write a program to model a robot that can move around and 
* fire a laser. To accomplish this you'll need to work with two classes:
* a Point (which has integer X and Y coordinates) and a Robot (which has
* a Point and an integer amount of energy).
************************************************************************/
#include "robot.h"
#include "point.h"
